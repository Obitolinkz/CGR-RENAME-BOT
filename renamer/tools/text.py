...
class TEXT:
    ...
    UPLOAD_SUCESS = f"Thanks for using [me](https://github.com/cutegirlrani/CGR-RENAME-BOT)"
...
** Source Code:** [Press Me](https://github.com/cutegirlrani/CGR-RENAME-BOT)
"""
...
**For Donate:** message me @cute_girl_rani"""
